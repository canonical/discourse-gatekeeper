    ...
    Token(
        ...
        children=[
            Token(
                ...
                tag="a",
                nesting=1,
                attrs={"href": "https://charmhub.io/nginx-ingress-integrator/actions"},
                map=None,
                level=0,
                children=None,
                content="",
        ...
        content="[Actions](https://charmhub.io/nginx-ingress-integrator/actions)",
        markup="",
        info="",
        meta={},
        block=True,
    ...
    Token(
        ...
        children=[
            Token(
                ...
                tag="a",
                nesting=1,
                attrs={"href": "https://charmhub.io/nginx-ingress-integrator/configure"},
                map=None,
                level=0,
                children=None,
                content="",
        ...
        content="[Configurations](https://charmhub.io/nginx-ingress-integrator/configure)",
        markup="",
        info="",
        meta={},
        block=True,
    ...
    Token(
        ...
        children=[
            Token(
                ...
                tag="a",
                nesting=1,
                attrs={"href": "reference/integrations.md"},
                map=None,
                level=0,
                children=None,
                content="",
        ...
        content="[Integrations](reference/integrations.md)",
        markup="",
        info="",
        meta={},
        block=True,
